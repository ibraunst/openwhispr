...
try {
  ...
  const userDataPath =
    process.platform === "darwin"
      ? path.join(os.homedir(), "Library", "Application Support", "custom-whispr")
      : process.platform === "win32"
      ? path.join(process.env.APPDATA || os.homedir(), "custom-whispr")
      : path.join(os.homedir(), ".config", "custom-whispr");
