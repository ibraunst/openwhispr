  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          onClick={async () => {
            const result = await window.electronAPI?.openExternal("mailto:support@customwhispr.com");
            if (!result?.success) {
              openExternal("https://mail.google.com/mail/?view=cm&to=support@customwhispr.com");
            }
          }}
        >
        ...
        <DropdownMenuItem
          onClick={() => openExternal("https://github.com/customWhispr/customwhispr/issues")}
        >
