...
const DEFAULT_DESKTOP_CALLBACK_URL = "https://customwhispr.com/auth/desktop-callback";
...
class GoogleCalendarOAuth {
  ...
  _getDesktopCallbackUrl() {
    return process.env.VITE_CUSTOMWHISPR_OAUTH_CALLBACK_URL || DEFAULT_DESKTOP_CALLBACK_URL;
  }

  _getProtocol() {
    const channel = process.env.CUSTOMWHISPR_CHANNEL || "production";
