...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.CUSTOMWHISPR_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.CUSTOMWHISPR_TRANSCRIPTION_BASE_URL as string | undefined,
...
export const CUSTOMWHISPR_API_URL = (env.VITE_CUSTOMWHISPR_API_URL as string) || "";
