...
2. Ensure customWhispr is listed and enabled
...
3. Ensure customWhispr is listed and enabled
...
4. Clear model cache: `rm -rf ~/.cache/customwhispr/whisper-models`
...
3. Restart customWhispr after installing

customWhispr tries clipboard methods in order: `wl-copy` (most reliable) → renderer `navigator.clipboard` → X11 fallback.
...
**macOS:**
1. Grant Screen Recording permission: System Settings → Privacy & Security → Screen Recording → enable customWhispr
...
3. Open an issue at https://github.com/customWhispr/customwhispr/issues with:
   - OS version
